                ...
                return (
                    <div>
                        {reserved && reserved.length > 0 ? reserved.map((item) =>
                            <div className='flex flex-col gap-5 lg:gap-10 w-full px-20 lg:px-32'>
                                <div className='flex w-full justify-between'>
                                    <div className='flex gap-5'>
                                        <img className='w-24 h-24 lg:w-32 lg:h-32 rounded-lg' src={process.env.REACT_APP_IMG + '/' + item.BookId.file} />
                ...
                return (
                    <div>
                        {waitForPayment && waitForPayment.length > 0 ? waitForPayment.map((item) =>
                            <div className='flex flex-col gap-5 lg:gap-10 w-full px-20 lg:px-40'>
                                <div className='flex w-full justify-between'>
                                    <div className='flex gap-5'>
                                        <img className='w-24 h-24 lg:w-32 lg:h-32 rounded-lg' src={process.env.REACT_APP_IMG + '/' + item.BookId.file} />
                                        <div className='flex flex-col gap-1 lg:gap-2 items-start'>
